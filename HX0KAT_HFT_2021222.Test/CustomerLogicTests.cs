...
namespace HX0KAT_HFT_2021222.Test
{
    ...
    {
        public CustomerLogic CustomerLogic { get; set; }
        ...
        public void Setup()
        {
            ...
            this.CustomerLogic = new CustomerLogic(mockedCustomerRepo.Object, mockedPhoneRepo.Object, mockedRepairerRepo.Object);
        }
        ...
        {
            IEnumerable<Customer> customerList = this.CustomerLogic.GetAllCustomersWithSameFirstName(firstName);
