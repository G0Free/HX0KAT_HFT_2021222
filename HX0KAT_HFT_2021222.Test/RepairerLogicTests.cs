...
{
    [TestFixture]
    public class RepairerLogicTests
    {
        public RepairerLogic RepairerLogic{ get; set; }
        ...
        public void Setup()
        {
            ...
            this.RepairerLogic = new RepairerLogic(mockedRepairerRepo.Object, mockedPhoneRepo.Object, mockedCustomerRepo.Object);
        }
