...
namespace HX0KAT_HFT_2021222.Endpoint
{
    public class Startup
    {
        ...
        {
            services.AddTransient<PhoneShopDbContext>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "HX0KAT_HFT_2021222.Endpoint", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "HX0KAT_HFT_2021222.Endpoint v1"));
            }
